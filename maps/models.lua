...
local function init()
    for _, t in ipairs{{
        ...
        renderer = {
            ...
            scale = {10, 10, 10},
            obj = "obj/cube.obj", tex = "img/white.png"},
    }, {
        -- human
        renderer = {
            type = Renderer.MODEL, flags = Renderer.MODEL_DEDUP,
            obj = "obj/human.obj", tex = "img/white.png"},
    }, {
        -- animals
        pos = {-192, 0, 0},
        renderer = {
            ...
            obj = "obj/tiger.obj", tex = "img/white.png",
        ...
        renderer = {
            ...
            obj = "obj/deer0.obj", tex = "img/white.png"},
    }, {
        pos = {-80, 0, 0},
        renderer = {
            type = Renderer.MODEL,
            flags = Renderer.MODEL_DEDUP | Renderer.MODEL_CALC_NORMALS,
            obj = "obj/deer1.obj", tex = "img/white.png",
        ...
        renderer = {
            type = Renderer.MODEL,
            flags = Renderer.MODEL_DEDUP | Renderer.MODEL_CALC_NORMALS,
            obj = "obj/wolf0.obj", tex = "img/white.png",
        ...
        renderer = {
            type = Renderer.MODEL,
            flags = Renderer.MODEL_DEDUP | Renderer.MODEL_CALC_NORMALS,
            obj = "obj/wolf1.obj", tex = "img/white.png",
        ...
        renderer = {
            type = Renderer.MODEL,
            flags = Renderer.MODEL_DEDUP | Renderer.MODEL_CALC_NORMALS,
            obj = "obj/cat.obj", tex = "img/white.png",
            scale = .05, rot = {1, -1, -1, math.rad(120)}},
    }, {
        pos = {96, 0, 0},
        renderer = {
            type = Renderer.MODEL,
            flags = Renderer.MODEL_DEDUP | Renderer.MODEL_CALC_NORMALS,
            obj = "obj/goat.obj", tex = "img/white.png",
            scale = .075, rot = {1, -1, -1, math.rad(120)}},
    }, {
        pos = {144, 0, 0},
        renderer = {
            type = Renderer.MODEL,
            flags = Renderer.MODEL_DEDUP | Renderer.MODEL_CALC_NORMALS,
            obj = "obj/cow.obj", tex = "img/white.png",
            scale = .05, rot = {1, -1, -1, math.rad(120)}},
    }, {
        pos = {192, 64, 30},
        renderer = {
            type = Renderer.MODEL,
            flags = Renderer.MODEL_DEDUP | Renderer.MODEL_CALC_NORMALS,
            obj = "obj/dragon.obj", tex = "img/white.png",
...
map.map {
    ...
    heartbeat = heartbeat,
    tiles = {
        nngn.textures:load("img/white.png"),
