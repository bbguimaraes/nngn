...
local function init()
    ...
    -- flowers
    do
        local t = dofile("src/lson/zelda/flower.lua")
        for _, p in ipairs{
            {-76, 172}, {-12, 172}, {-68, 164}, {-44, 12}, {52, -84},
        } do
            t.pos = p
    ...
    -- chest
    do
        local t = dofile("src/lson/zelda/chest.lua")
        t.pos = {16, 184, 0}
    ...
    table.insert(entities, entity.load(nil, nil, {
        ...
        renderer = {
            ...
            size = {16, 24}, scale = {512//16, 512//8}, coords = {5, 0, 6, 3}},
        collider = {
    ...
    for _, t in pairs({
        ...
        -- trunk
        {{ -12, -248}, {  -4,  -20,   4,  20},   0.0},
        {{  28, -248}, {  -4,  -20,   4,  20},   0.0},
        -- platform
        {{  -8,  152}, { -40,   -8,  40,   8},   0.0},
    ...
    table.insert(entities, entity.load(nil, nil, {
        pos = {0, 0}, z_off = -128,
        renderer = {
            type = Renderer.SPRITE, tex = "img/zelda/sacred_grove.png",
...
local function on_collision(e0, e1)
    ...
    elseif e0 == chest or e1 == chest then
        ...
        local t = dofile("src/lson/zelda/fairy1.lua")
    ...
    elseif e0 == sword or e1 == sword then
        ...
        table.insert(animations, animation.chain{
            ...
            animation.fn(function()
                local fairies = {}
                for _, t in ipairs{
                    {"src/lson/zelda/fairy0.lua", {-96,  0, 0}},
                    {"src/lson/zelda/fairy1.lua", {-32, 48, 0}},
                } do
