...
struct Input {
    ...
    struct Source {
        virtual ~Source() = 0;
        virtual void get_keys(std::size_t n, std::int32_t *keys) const;
    ...
    void get_keys(std::size_t n, std::int32_t *keys) const;
    void has_override(std::size_t n, std::int32_t *keys) const;
    ...
    bool override_keys(bool pressed, std::size_t n, const std::int32_t *keys);
