...
NNGN_LUA_PROXY(Graphics,
    ...
    "set_automatic_exposure", &Graphics::set_automatic_exposure,
    "set_exposure", &Graphics::set_exposure,
    "set_bloom_downscale", &Graphics::set_bloom_downscale,
    "set_bloom_threshold", &Graphics::set_bloom_threshold,
    "set_bloom_blur_size", &Graphics::set_bloom_blur_size,
    "set_bloom_blur_passes", &Graphics::set_bloom_blur_passes,
    "set_bloom_amount", &Graphics::set_bloom_amount,
    "set_blur_downscale", &Graphics::set_blur_downscale,
    "set_blur_size", &Graphics::set_blur_size,
    "set_blur_passes", &Graphics::set_blur_passes,
    "set_HDR_mix", &Graphics::set_HDR_mix,
