...
void set_pos(Entity *e, nngn::vec3 oldp, nngn::vec3 p) {
...
void Entities::set_max(std::size_t n) {
    ...
    nngn::set_capacity(&this->names, n);
    nngn::set_capacity(&this->tags, n);
    nngn::set_capacity(&this->name_hashes, n);
    nngn::set_capacity(&this->tag_hashes, n);
}
