...
NNGN_LUA_PROXY(Lighting,
    ...
    "zsprites", &Lighting::zsprites,
    "update_sun", &Lighting::update_sun,
    ...
    "set_zsprites", &Lighting::set_zsprites,
    "set_update_sun", &Lighting::set_update_sun,
    "set_shadows_enabled", &Lighting::set_shadows_enabled,
    "set_ambient_light", s<&Lighting::set_ambient_light>,
    "set_ambient_anim", set_ambient_anim,
    "set_sun_light", &Lighting::set_sun_light,
    "set_shadow_map_proj_size", &Lighting::set_shadow_map_proj_size,
    "set_shadow_map_near", &Lighting::set_shadow_map_near,
    "set_shadow_map_far", &Lighting::set_shadow_map_proj_size,
