...
template<template<typename> typename CRTP, typename T, std::size_t N>
inline constexpr const T &vec<CRTP, T, N>::operator[](std::size_t i) const {
    return this->data()[i];
}

template<template<typename> typename CRTP, typename T, std::size_t N>
inline constexpr T &vec<CRTP, T, N>::operator[](std::size_t i) {
...
template<template<typename> typename CRTP, typename T, std::size_t N>
constexpr T *vec<CRTP, T, N>::data(void) {
    return &static_cast<CRTP<T>&>(*this).x;
}

template<template<typename> typename CRTP, typename T, std::size_t N>
constexpr const T *vec<CRTP, T, N>::data(void) const {
    return &static_cast<const CRTP<T>&>(*this).x;
}
