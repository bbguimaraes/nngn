...
struct vec {
    ...
    template<typename U> explicit constexpr operator CRTP<U>() const;
    constexpr vec &operator=(const CRTP<T> &v);
    constexpr T &operator[](int i);
    constexpr const T &operator[](int i) const;
    constexpr CRTP<T> operator-() const;
    ...
    constexpr CRTP<T> &operator*=(const CRTP<T> &v);
    constexpr CRTP<T> &operator/=(const CRTP<T> &v);
    template<std::size_t I> constexpr T &get();
    template<std::size_t I> constexpr const T &get() const;
};

template<template<typename> typename T, typename U>
concept vector = std::derived_from<T<U>, vec<T, U, T<U>::n_dim>>;
...
template<template<typename> typename CRTP, typename T, std::size_t N>
template<typename U>
inline constexpr vec<CRTP, T, N>::operator CRTP<U>() const
...
template<template<typename> typename CRTP, typename T, std::size_t N>
inline constexpr CRTP<T> vec<CRTP, T, N>::operator-() const
...
template<template<typename> typename CRTP, typename T, std::size_t N>
template<std::size_t I> constexpr const T &vec<CRTP, T, N>::get() const {
    static_assert(I < N);
